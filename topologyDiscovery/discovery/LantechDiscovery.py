...
class LantechDiscovery(BaseDiscovery):
    ...
    def get_basic_info(self) -> Dict[str, Any]:
        ...
        try:
            output = self.ssh_client.send_command_to_shell("System configuration", 3.0)
            if output and ("TPES" in output or "tpes" in output.lower()):
    ...
    def _parse_basic_info(self, output: str) -> Dict[str, Any]:
        ...
        # Extract MAC address
        mac_match = re.search(r"MacAddr\.+(.+)", output, re.IGNORECASE)
        if mac_match:
    ...
    def get_neighbors(self) -> List[NeighborInfo]:
        ...
        try:
            output = self.ssh_client.send_command_to_shell("lldp neighborinfo", 3.0)
            if output:
    ...
    def _parse_lldp_neighbors(self, output: str) -> List[NeighborInfo]:
        ...
        for line in lines:
            ...
            elif 'SystemDescription' in line:
    ...
    def get_switch_info(self) -> SwitchInfo:
        ...
        try:
            ...
            return SwitchInfo(
                ...
                type=basic_info.get('vendor', 'lantech'),
                neighbors=neighbors
            )
